      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 font-medium">Sign in to your email marketing dashboard</p>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    {...register('password')}
                    className={`h-12 text-base pr-12 ${errors.password ? 'border-red-400 focus-visible:ring-red-400' : 'border-gray-200 focus-visible:ring-amber-600'} transition-colors`}
                  />
                  <button
                    type="button"
          ...
          <div className="text-center">
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
              <p className="text-xs font-semibold text-gray-600 mb-3 uppercase tracking-wide">Demo Accounts</p>
              <div className="space-y-2 text-sm text-gray-600">
                <div className="flex items-center justify-between">
                  <p className="font-medium">admin@test.com / password123</p>
                  <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-amber-100 text-amber-800 rounded-full">
                    ADMIN
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <p className="font-medium">user@demo.com / demo123</p>
